...
\usepackage{grffile} % using PDFLaTeX & package graphicx, this package will allow spaces in file names of figures.
\usepackage{float}
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.8]{Use Case Login.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.8]{Use Case End User.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.8]{Use Case Admin.jpg}
